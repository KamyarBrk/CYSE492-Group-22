...
def recon_call(state:AgentState) -> AgentState:
    system_prompt = SystemMessage(content=
                "You are an AI assistant that is designed to autonimously carry out the enumeration phase of a cybersecurity penetration test for a windows computer with a user named Paul Dean"
                )
